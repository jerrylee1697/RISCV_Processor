...
HD_PWD='D:/OneDrive/EECS 31L/Final/RISCV/RISCV.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log basys3_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source basys3_wrapper.tcl -notrace
