...
HD_PWD='D:/OneDrive/EECS 31L/Final/RISCV/RISCV.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log basys3_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source basys3_wrapper.tcl
